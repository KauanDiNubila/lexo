...
- [Auto-deploy na master](feedback_auto_deploy_on_master.md) — Render DEVERIA auto-deployar na master, mas em 2026-06-18 NÃO disparou no merge do PR (precisou Manual Deploy); sempre VERIFICAR via curl nos headers de prod após push, não assumir que subiu
